package com.supportportalMehdi.demo.exception.domain;
...
public class ExceptionHandling implements ErrorController {
    ...
    private static final String ACCOUNT_LOCKED = "Your account has been locked. Please contact administation" ;
    ...
    public ResponseEntity<HttpResponse> accessDeniedException(AccessDeniedException exception){
        ...
        LOGGER.error("My Exception why Denied 403!?:"+exception.getMessage());
...
//    }
    ...
    public ResponseEntity<HttpResponse> internalServerErrorException(Exception exception){
        LOGGER.error("My Exception why500!?:"+exception.getMessage());
